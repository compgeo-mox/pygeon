...
def test_simple_voronoi_grid():
    ...
    # fmt: on
    sd_face_nodes = sps.csc_array(
        (
            np.ones_like(sd_face_nodes_indices),
            sd_face_nodes_indices,
            sd_face_nodes_indptr,
        )
    )

    sd_cell_faces = sps.csc_array(
        (
            sd_cell_faces_data,
            sd_cell_faces_indices,
            sd_cell_faces_indptr,
        )
    )
