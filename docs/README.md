...
**Note**: The `make html` command automatically runs `sphinx-apidoc` to generate API documentation from your source code, so the API docs are always up-to-date with your code.
